<template>
  <div class="overlay-page" :class="{ active: currentPage === 'studio' }">
    <div class="editorial-layout tilt-card">
      <div class="glass-panel">
        ...
        <p class="text-block text-anim-std">
          Мы создаём <strong>авторские путешествия</strong>, которые меняют взгляд на мир.
          Happy Tour — это не просто турагентство, это философия осознанных путешествий.
        </p>
        <p class="text-block text-anim-std">
          Каждый маршрут разрабатывается нашими экспертами с учётом ваших пожеланий.
          Мы работаем только с проверенными отелями и гидами, чтобы ваш отпуск стал незабываемым.
        </p>
      </div>
    </div>
  </div>
...
function animateContent() {
  gsap.fromTo('.text-anim-std', { opacity: 0, z: -50 }, {
